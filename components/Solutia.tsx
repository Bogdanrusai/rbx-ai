...
const shifts = [
  { from: "Clientul așteaptă ore", to: "Răspuns în câteva secunde" },
  { from: "Tu prinzi mesajele când poți", to: "Sistemul le prinde pe toate" },
  { from: "Programări pe telefon", to: "Calendarul se completează singur" },
];
